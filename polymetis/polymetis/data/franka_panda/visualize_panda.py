...
def main():
    ...
    robotId = p.loadURDF("/home/hisham246/uwaterloo/fairo/polymetis/polymetis/data/franka_panda/panda_arm_tcp.urdf", useFixedBase=True)
    
    target_link = "panda_hand_tcp"
